...
#define SERV_0_HEADER "ScanPortsFSM.h"
// the name of the Init function
#define SERV_0_INIT InitScanPortsFSM
// the name of the run function
#define SERV_0_RUN RunScanPortsFSM
...
#define EVENT_CHECK_LIST Check4Lock, Check4Unlock
